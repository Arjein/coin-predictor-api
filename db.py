# # Databaseda son 1000 rowun olmasini istiyoruz.
# #
...
# import asyncio
# import pandas as pd
# from managers.binance_manager import BinanceAPIManager
# from flask_socketio import SocketIO
# import threading
# from managers.fear_greed_manager import FearIndexAPI
...
#             # Store only the last 5000 klines into database.
#             if total_rows > 5000:
#                 self.cleanup_klines()
#             self.cleanup_klines()
...
#         with self.app.app_context():
#             # Subquery to get IDs of the latest 1000 records
...
#             self.db.session.commit()
#             print(f"🗑️ Deleted {result.rowcount} old kline records, keeping only the latest 1000.")
